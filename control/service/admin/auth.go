...
func (a *Admin) CompleteAuth(
	ctx context.Context,
	params AuthIdentityParams,
) (AuthResult, error) {
...
func (a *Admin) CompleteTwoFactor(
	ctx context.Context,
	challenge, code, ip string,
) (AuthResult, error) {
	mergedCtx, cancel := a.withContext(ctx)
	defer cancel()
...
func (a *Admin) GetAccount(
	...
	value, err := a.repository.GetAccount(
		mergedCtx,
...
func (a *Admin) ListIdentities(
	...
	items, err := a.repository.ListIdentities(
		mergedCtx,
		strings.TrimSpace(accountID),
	)
	if err != nil {
...
func (a *Admin) BindIdentity(
	...
	return a.repository.BindIdentity(
		mergedCtx,
		accountID,
		repository.IdentityInput{
			Provider:    provider,
...
func (a *Admin) ListSessions(
	...
	items, err := a.repository.ListSessions(
		mergedCtx,
		strings.TrimSpace(accountID),
	)
	if err != nil {
...
func (a *Admin) RevokeAllSessions(
	ctx context.Context,
	accountID, exceptSessionID string,
) (int64, error) {
	accountID = strings.TrimSpace(accountID)
...
func (a *Admin) BeginTwoFactor(
	ctx context.Context,
	accountID, issuer string,
) (TwoFactorSetupModel, error) {
	accountID = strings.TrimSpace(accountID)
	...
	value, err := a.repository.BeginTwoFactor(
		mergedCtx,
		accountID,
