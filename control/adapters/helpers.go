...
func (o *OAuth2) exchangeCode(
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		return "", serviceerrors.Wrap(
			...
			providerResponseError{statusCode: resp.StatusCode},
		)
	}
...
func (o *OAuth2) fetchProfile(
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		return nil, nil, serviceerrors.Wrap(
			serviceerrors.CodeUnauthorized,
...
func oAuth2ProviderConfigFromAuthParams(
