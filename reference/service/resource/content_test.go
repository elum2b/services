...
func (s *contentStore) Replace(context.Context, string, string, string, storage.Files) (storage.Objects, error) {
...
func TestGetContentRejectsInvalidVariant(t *testing.T) {
	service := &Resource{store: &contentStore{}, cache: resourcecache.New(resourcecache.Config{})}
	_, err := service.GetContent(context.Background(), ContentParams{WorkspaceID: "c2b604c6-6960-41a7-b330-5083ca633434", Key: "logo", Version: "AbCdEfGh", Size: 64})
	if err == nil {
