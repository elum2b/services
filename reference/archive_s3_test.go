...
func TestS3ArchiveStoreOpenDelete(t *testing.T) {
	...
	key, err := archive.Store(t.Context(), jobs.ArchiveObject{}, strings.NewReader("archive"))
	if err != nil {
		t.Fatal(err)
	}
	...
	if _, err := archive.Open(t.Context(), "importexport/../archive.zip"); err == nil {
...
func (c *fakeArchiveClient) PutObject(_ context.Context, input *awss3.PutObjectInput, _ ...func(*awss3.Options)) (*awss3.PutObjectOutput, error) {
...
func (c *fakeArchiveClient) GetObject(_ context.Context, input *awss3.GetObjectInput, _ ...func(*awss3.Options)) (*awss3.GetObjectOutput, error) {
...
func (c *fakeArchiveClient) DeleteObject(_ context.Context, input *awss3.DeleteObjectInput, _ ...func(*awss3.Options)) (*awss3.DeleteObjectOutput, error) {
