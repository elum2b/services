...
CREATE TABLE IF NOT EXISTS payment_ton_wallet (
    ...
    manifest_app_url VARCHAR(2048) NOT NULL DEFAULT '',
    manifest_name VARCHAR(255) NOT NULL DEFAULT '',
    manifest_icon_url VARCHAR(2048) NOT NULL DEFAULT '',
    manifest_terms_of_use_url VARCHAR(2048) NULL,
    manifest_privacy_policy_url VARCHAR(2048) NULL,
...
ALTER TABLE payment_ton_wallet
    ADD COLUMN IF NOT EXISTS manifest_app_url VARCHAR(2048) NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS manifest_name VARCHAR(255) NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS manifest_icon_url VARCHAR(2048) NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS manifest_terms_of_use_url VARCHAR(2048) NULL,
    ADD COLUMN IF NOT EXISTS manifest_privacy_policy_url VARCHAR(2048) NULL;
