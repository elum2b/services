...
func (o *Operational) UpsertProvider(
	ctx context.Context,
	...
	return o.repository.UpsertProvider(
		mergedCtx,
		repository.ProviderUpsertParams{
			Code:             params.Code,
			Title:            params.Title,
...
func (o *Operational) DeleteProvider(
	ctx context.Context,
	code string,
) (int64, error) {
	mergedCtx, cancel := contextutil.Merge(o.rootCtx, ctx)
...
func (o *Operational) UpsertAsset(
	ctx context.Context,
...
func (o *Operational) DeleteAsset(
	ctx context.Context,
	code string,
) (int64, error) {
	mergedCtx, cancel := contextutil.Merge(o.rootCtx, ctx)
...
func (o *Operational) UpsertProviderAsset(
	ctx context.Context,
	...
	return o.repository.UpsertProviderAsset(
		mergedCtx,
		repository.ProviderAssetUpsertParams{
