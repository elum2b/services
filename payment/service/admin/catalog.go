...
func (a *Admin) ListProductGroups(
	ctx context.Context,
...
func (a *Admin) UpsertProductGroup(
	ctx context.Context,
...
func (a *Admin) DeleteProductGroup(
	ctx context.Context,
	workspaceID string,
	code string,
) (int64, error) {
...
func (a *Admin) UpsertProductItem(
	ctx context.Context,
...
func (a *Admin) DeleteProductLimitCounter(
	ctx context.Context,
	params ProductLimitCounterDeleteParams,
) (int64, error) {
	mergedCtx, paymentRequestCancel := a.withContext(ctx)
	defer paymentRequestCancel()
	ctx = mergedCtx
