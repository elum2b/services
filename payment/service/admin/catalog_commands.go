...
func (a *Admin) SaveProductGroup(
	ctx context.Context,
	params SaveProductGroupParams,
) error {
	if a == nil || a.products == nil {
		return ErrProductServiceNotInitialized
	}
...
func (a *Admin) AttachProductItem(
	ctx context.Context,
	params AttachProductItemParams,
) error {
	if a == nil || a.products == nil {
		return ErrProductServiceNotInitialized
	}
...
func (a *Admin) CreateCatalogPrice(
	ctx context.Context,
	params CreateCatalogPriceParams,
) (uint64, error) {
	if a == nil || a.products == nil {
...
func (a *Admin) UpdateCatalogPrice(
	ctx context.Context,
	params UpdateCatalogPriceParams,
) (int64, error) {
	if a == nil || a.products == nil {
		return 0, ErrProductServiceNotInitialized
	}
