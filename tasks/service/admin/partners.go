...
func (a *Admin) SavePartnerConfig(
	ctx context.Context,
	params PartnerConfigModel,
) error {
...
func (a *Admin) ListPartnerConfigs(
	ctx context.Context,
	workspaceID string,
...
func (a *Admin) SavePartnerRewardRule(
	ctx context.Context,
...
func (a *Admin) ListPartnerDailyStats(
	...
	for _, value := range values {
		result = append(result, PartnerDailyStatsModel{
			...
			RevokedAfterClaimCount: value.RevokedAfterClaimCount,
			FailedCount:            value.FailedCount,
			FakeCount:              value.FakeCount,
			ExpiredCount:           value.ExpiredCount,
			UniqueIssuedUsers:      value.UniqueIssuedUsers,
			UniqueCompletedUsers:   value.UniqueCompletedUsers,
