...
func mapCalendar(value repository.Calendar) CalendarModel {
	...
	for _, step := range value.Steps {
		item := StepModel{
			...
			Rewards:  make([]RewardModel, 0, len(step.Rewards)),
		}
