...
func (r *Repository) CreateCalendar(
	ctx context.Context,
	...
	err := r.WithTx(ctx, func(txRepo *Repository) error {
		...
		return txRepo.q.AdminCreateCalendar(
			ctx,
			calendarsqlc.AdminCreateCalendarParams{
				ID:                  params.ID,
...
func (r *Repository) UpdateCalendar(
	ctx context.Context,
	params SaveCalendarParams,
) (int64, error) {
	var rows int64
...
func (r *Repository) GetCalendarDefinition(
	ctx context.Context,
	...
	return sqlwrap.Query(ctx, r.db, sqlwrap.Params{
		...
		CacheVersionScope: calendarCacheScope(
			calendarCacheAdminCalendar,
			workspaceID,
		),
	}, func(ctx context.Context) (Calendar, error) {
		row, err := r.q.AdminGetCalendar(
			ctx,
			calendarsqlc.AdminGetCalendarParams{
...
func (r *Repository) ListCalendars(
	ctx context.Context,
	workspaceID string,
	limit, offset int32,
) ([]Calendar, error) {
	...
	return sqlwrap.Query(ctx, r.db, sqlwrap.Params{
		...
		CacheL2Delay: r.cacheL2,
		CacheVersionScope: calendarCacheScope(
			calendarCacheAdminList,
			workspaceID,
		),
	}, func(ctx context.Context) ([]Calendar, error) {
		rows, err := r.q.AdminListCalendars(
			ctx,
			calendarsqlc.AdminListCalendarsParams{
				WorkspaceID: workspaceID,
				Limit:       limit,
				Offset:      offset,
			},
...
func (r *Repository) SetCalendarActive(
	ctx context.Context,
	workspaceID, id string,
	active bool,
) (int64, error) {
...
func (r *Repository) DeleteCalendar(
	ctx context.Context,
	workspaceID, id string,
) (int64, error) {
	var rows int64
	...
	err := r.withWorkspaceMutation(
		...
		func(txRepo *Repository) error {
			return txRepo.q.AdminUpsertLocalization(
				ctx,
				calendarsqlc.AdminUpsertLocalizationParams{
...
func (r *Repository) GetLocalization(
	...
	key := calendarCacheKey(
		calendarCacheAdminLocalization,
		workspaceID,
		calendarID,
		locale,
	)
	...
	return sqlwrap.Query(ctx, r.db, sqlwrap.Params{
		...
		row, err := r.q.AdminGetLocalization(
			ctx,
			calendarsqlc.AdminGetLocalizationParams{
				WorkspaceID: workspaceID,
...
func (r *Repository) ListLocalizations(
	...
	return sqlwrap.Query(ctx, r.db, sqlwrap.Params{
		...
		rows, err := r.q.AdminListLocalizations(
			ctx,
			calendarsqlc.AdminListLocalizationsParams{
				WorkspaceID: workspaceID,
				CalendarID:  calendarID,
			},
		)
...
func (r *Repository) GetStep(
	ctx context.Context,
	workspaceID, calendarID string,
	id uint64,
) (Step, error) {
	row, err := r.q.AdminGetStep(
		ctx,
		calendarsqlc.AdminGetStepParams{
			WorkspaceID: workspaceID,
			CalendarID:  calendarID,
			ID:          int64(id),
		},
...
func (r *Repository) ListSteps(
	ctx context.Context,
	workspaceID, calendarID string,
) ([]Step, error) {
	rows, err := r.q.AdminListSteps(
		ctx,
		calendarsqlc.AdminListStepsParams{
			WorkspaceID: workspaceID,
			CalendarID:  calendarID,
		},
	)
...
func (r *Repository) ListRewards(
	...
	rows, err := r.q.AdminListRewards(
		ctx,
		calendarsqlc.AdminListRewardsParams{
			WorkspaceID: workspaceID,
			CalendarID:  calendarID,
		},
	)
